...
class BlockbeamControllerPD(ControllerBase):
    """
    Example:
    ...
    def __init__(self):
        ...
        b0_z = P.tf_outer_num[-1]
        a1_z, a0_z = P.tf_outer_den[-2:]
    ...
    def update_with_state(self, r, x):
        ...
        z = x[0]  # RENAME to match your system (z, theta, etc.)
        zdot = x[2]  # RENAME to match your system (zdot, thetadot, etc.)

        theta = x[1]  # RENAME to match your system (z, theta, etc.)
        thetadot = x[3]  # RENAME to match your system (zdot, thetadot, etc.)

        self.u_eq = P.g*P.m2/2 + P.g*P.m1*z/P.ell
        ...
        theta_ref = self.kp_z * z_error - self.kd_z * zdot
        r[1] = theta_ref
        theta_error = theta_ref - theta
        f_tilde = self.kp_th * theta_error - self.kd_th * thetadot 

        # Add equilibrium control (linearization point)
        u_total = f_tilde + self.u_eq
